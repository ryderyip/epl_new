...
<jsp:useBean id="bookingApproved" scope="request" class="ict.data_objects.entities.BookingApprovedDetails"/>
...
<html lang="en">
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td><label class="form-label">Booking Approval Status:</label><br>
              <c: if(!${bookingApproved.isPaymentConfirmed()})>
    ...
    <ul>
        <li>Check-in Time: </li>
        <li>Check-out Time: ${CheckOut.getTime()}</li>
        <li>Check-out Remarks: ${CheckOut.getStaffRemarks()}</li>
