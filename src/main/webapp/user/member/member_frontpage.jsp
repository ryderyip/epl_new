    ...
    <table border="0" width="100%">
        <tr>
            ...
            <td width="30%">
                <table border="1" width="90%">
                    <tr>
                        <td align="center"><a href="${pageContext.request.contextPath}/user/member/my_booking.jsp"><img src="${pageContext.request.contextPath}/img/manage.png" width="250px" height=250px"/></a></td>
                    </tr>
                    <tr>
                        <td align="center"><a class="btn btn-primary" href="${pageContext.request.contextPath}/user/member/my_booking.jsp">Booking Management</a></td>
                    </tr>
                </table>
            </td>
